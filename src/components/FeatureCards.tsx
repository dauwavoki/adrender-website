...
const FEATURES: FeatureCard[] = [
  ...
  },
  {
    ...
    body: 'Pick a proven format, hit generate, get a batch. On-brand, ready to run, no prompt engineering required. The step that used to take three hours takes three minutes.',
    imageId: '10',
    icon: Sparkles,
    accent: 'text-[#00E5FF]',
  },
  ...
  },
  {
    ...
    body: 'Square, Portrait, Story/Reel, Landscape, Feed Banner, Pinterest Pin, Medium Rectangle, Half Page, Leaderboard, Wide Skyscraper, Mobile Banner. Facebook, Instagram, LinkedIn, Google, TikTok — sized correctly, no manual resizing. 1K, 2K, or 4K resolution.',
    imageId: '12',
    icon: Maximize2,
    accent: 'text-[#5B9FFF]',
  },
