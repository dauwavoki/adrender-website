...
const FEATURES: FeatureCard[] = [
  {
    ...
    body: 'Not stock layouts — actual ads running right now, filterable by niche, platform, runtime, and market. Static and video, all searchable in one library.',
    imageId: '07',
    icon: LayoutGrid,
    accent: 'text-[#B894F0]',
  },
  ...
  },
  {
    ...
    body: "Upload your own templates or reference video, start from a blank slate, or riff on something halfway. Full creative control when you want it — for static or video, for the times a template isn't the answer.",
    imageId: '11',
    icon: Wand2,
    accent: 'text-[#B894F0]',
  },
  {
    ...
    sub: '11 formats. Every platform. Every video length up to 30 seconds. One generation.',
    body: 'For images, choose 1K, 2K, or 4K resolution, and Standard or Pro generation quality. Video renders up to 30 seconds today, with longer coming soon. No resizing, no re-exporting, no cropping by hand.',
    imageId: '12',
    icon: Maximize2,
    accent: 'text-[#5B9FFF]',
  },
